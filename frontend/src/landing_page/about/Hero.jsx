...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top text-muted fs-6" style={{lineHeight:"1.8",fontSize:"1em"}}>
             ...
             <div className="col p-5">
                 ...
                 <p><a style={{textDecoration:"none"}}href="">Rain matter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
